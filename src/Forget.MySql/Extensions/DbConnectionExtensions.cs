...
namespace Forget.MySql.Extensions
{
    ...
    /// filtering, sorting, paging, and aggregation against MySQL, for any entity mapped with the
    ...
    public static partial class DbConnectionExtensions
    {
        ...
        /// </exception>
        public static IReadOnlyList<TEntity> GetByIdRange<TEntity>(this MySqlConnection connection, IEnumerable ids, int batchSize = 500, MySqlTransaction? transaction = null, int? commandTimeout = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
