...
namespace Forget.Tests.MySql
{
    ...
    public class TransactionIntegrationTests
    {
        ...
        public TransactionIntegrationTests(MySqlFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        /// </summary>
        private async Task RunEveryWriteAsync(MySqlTransaction tx)
        {
        ...
        {
            using MySqlTransaction tx = _fixture.Connection.BeginTransaction();
        ...
        {
            await using MySqlConnection other = new(_fixture.ConnectionString);
            await other.OpenAsync(Ct);
            await using MySqlTransaction foreign = other.BeginTransaction();
        ...
        public async Task TheCommandTimeout_ReachesTheDatabase()
        {
            ...
            await using MySqlConnection blocker = new(_fixture.ConnectionString);
            await blocker.OpenAsync(ct);
            await using MySqlTransaction held = blocker.BeginTransaction();
