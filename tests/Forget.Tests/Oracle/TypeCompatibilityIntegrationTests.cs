...
namespace Forget.Tests.Oracle
{
    ...
    public class TypeCompatibilityIntegrationTests
    {
        ...
        public TypeCompatibilityIntegrationTests(OracleFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        private static Widget NewWidget(int id, decimal price = 1m, int? quantity = null) => new() { Id = id, Name = "compat", IsActive = 1, Price = price, Quantity = quantity };
