...
namespace Forget.Tests.PostgreSql
{
    ...
    public class FilterCaseIntegrationTests
    {
        ...
        public FilterCaseIntegrationTests(PostgreSqlFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        private static Widget NewWidget(int id, string name) => new() { Id = id, Name = name, IsActive = true, Price = 1m };
