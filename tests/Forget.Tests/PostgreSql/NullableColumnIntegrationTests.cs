...
namespace Forget.Tests.PostgreSql
{
    ...
    public class NullableColumnIntegrationTests
    {
        ...
        public NullableColumnIntegrationTests(PostgreSqlFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        private static Widget NewWidget(int id, int? quantity) => new() { Id = id, Name = "Nullable", Quantity = quantity, IsActive = true, Price = 1m };
