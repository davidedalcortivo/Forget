...
namespace Forget.Tests.PostgreSql
{
    ...
    public class TransactionIntegrationTests
    {
        ...
        /// </summary>
        private async Task RunEveryWriteAsync(NpgsqlTransaction tx)
        {
            NpgsqlConnection connection = _fixture.Connection;
        ...
        {
            using NpgsqlTransaction tx = _fixture.Connection.BeginTransaction();
        ...
        {
            await using NpgsqlConnection other = new(_fixture.ConnectionString);
            await other.OpenAsync(Ct);
            await using NpgsqlTransaction foreign = other.BeginTransaction();
        ...
        public async Task TheCommandTimeout_ReachesTheDatabase()
        {
            ...
            await using NpgsqlTransaction held = blocker.BeginTransaction();
