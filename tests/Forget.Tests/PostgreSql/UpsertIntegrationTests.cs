...
namespace Forget.Tests.PostgreSql
{
    ...
    public class UpsertIntegrationTests
    {
        ...
        public UpsertIntegrationTests(PostgreSqlFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        /// </summary>
        private async Task RunAtOnceAsync(ConcurrentBag<Exception> failures, Func<NpgsqlConnection, int, Task> action)
        {
