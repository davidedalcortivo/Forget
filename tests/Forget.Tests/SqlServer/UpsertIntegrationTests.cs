...
namespace Forget.Tests.SqlServer
{
    ...
    public class UpsertIntegrationTests
    {
        ...
        public UpsertIntegrationTests(SqlServerFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        /// </summary>
        private async Task RunAtOnceAsync(ConcurrentBag<Exception> failures, Func<SqlConnection, int, Task> action)
        {
